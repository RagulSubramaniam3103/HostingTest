    ...
    public class UserFilesController : ControllerBase
    {
        ...
        public IActionResult InitDb()
        {
            try
            {
                ...
                {
                    string pgSql = @"
                        CREATE TABLE IF NOT EXISTS ""EWO_UserPersonalFiles"" (
                        ...
                        CREATE INDEX IF NOT EXISTS ""IX_EWO_UserPersonalFiles_UserId"" ON ""EWO_UserPersonalFiles"" (""UserId"");

                        DO $$
                        BEGIN
                            IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='EWO_MasterUser' AND column_name='ComicAccess') THEN
                                ALTER TABLE ""EWO_MasterUser"" ADD COLUMN ""ComicAccess"" boolean NOT NULL DEFAULT FALSE;
                            END IF;

                            IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='EWO_MasterUser' AND column_name='PrivateImageAccess') THEN
                                ALTER TABLE ""EWO_MasterUser"" ADD COLUMN ""PrivateImageAccess"" boolean NOT NULL DEFAULT FALSE;
                            END IF;

                            IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='EWO_ChatMessage' AND column_name='DeletedBy') THEN
                                ALTER TABLE ""EWO_ChatMessage"" ADD COLUMN ""DeletedBy"" text NULL;
                            END IF;

                            IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='EWO_ChatMessage' AND column_name='IsDeleted') THEN
                                ALTER TABLE ""EWO_ChatMessage"" ADD COLUMN ""IsDeleted"" boolean NOT NULL DEFAULT FALSE;
                            END IF;

                            IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='EWO_ChatGroup' AND column_name='ProfileImage') THEN
                                ALTER TABLE ""EWO_ChatGroup"" ADD COLUMN ""ProfileImage"" text NULL;
                            END IF;
                        END $$;

                        CREATE TABLE IF NOT EXISTS ""EWO_PersonalFileLike"" (
                            ""Id"" integer GENERATED BY DEFAULT AS IDENTITY,
                        ...
                        CREATE INDEX IF NOT EXISTS ""IX_EWO_PersonalFileLike_FileId"" ON ""EWO_PersonalFileLike"" (""FileId"");
                        CREATE INDEX IF NOT EXISTS ""IX_EWO_PersonalFileLike_UserId"" ON ""EWO_PersonalFileLike"" (""UserId"");

                        CREATE TABLE IF NOT EXISTS ""EWO_PartnerConnection"" (
                            ""Id"" integer GENERATED BY DEFAULT AS IDENTITY,
                        ...
                        CREATE INDEX IF NOT EXISTS ""IX_EWO_PartnerConnection_SenderId"" ON ""EWO_PartnerConnection"" (""SenderId"");
                        CREATE INDEX IF NOT EXISTS ""IX_EWO_PartnerConnection_ReceiverId"" ON ""EWO_PartnerConnection"" (""ReceiverId"");

                        CREATE TABLE IF NOT EXISTS ""EWO_PartnerSharedPhoto"" (
                            ""Id"" integer GENERATED BY DEFAULT AS IDENTITY,
                        ...
                        CREATE INDEX IF NOT EXISTS ""IX_EWO_PartnerSharedPhoto_ConnectionId"" ON ""EWO_PartnerSharedPhoto"" (""ConnectionId"");
                        CREATE INDEX IF NOT EXISTS ""IX_EWO_PartnerSharedPhoto_UploaderId"" ON ""EWO_PartnerSharedPhoto"" (""UploaderId"");
                    ";
                    _context.Database.ExecuteSqlRaw(pgSql);
                }
                else
                {
                    string sql = @"
        ...
        public async Task<IActionResult> GetPartners()
        {
            ...
            try
            {
                ...
                var partnerIds = partners.Select(p => p.PartnerId).Distinct().ToList();
                ...
                {
                    userMap.TryGetValue(p.PartnerId, out var user);
                    return new
                    {
